        ...
        <div class="brand" v-if="page == 2">
          <div class="brandList">
            <div
              ...
              @click="
                tab3Acitve = item.id;
                tab3AcitveClick(item.id);
                navArr[1].title = item.id == -1 ? '品牌' : item.name;
              "
              :class="{ active: tab3Acitve == item.id }"
            >
              <span>{{ item.name }}</span
              ><span>{{ item.count }}</span>
            </div>
            ...
            <div class="fun" v-if="service.length">
              ...
              <ul class="splist">
                <li
                  ...
                  @click="
                    tab4Acitve = item.id;
                    tab4AcitveClick(item.id);
                  "
                  :class="{ active: tab4Acitve == item.id }"
                >
                  {{ item.name }}
                </li>
              </ul>
            ...
            <div class="hall" v-if="hallType.length">
              ...
              <ul class="splist">
                <li
                  ...
                  @click="
                    tab5Acitve = item.id;
                    tab5AcitveClick(item.id);
                  "
                  :class="{ active: tab5Acitve == item.id }"
                >
                  {{ item.name }}
                </li>
              </ul>
  ...
  methods: {
    ...
    tabAcitveClick(t1) {
      if (t1 == 0) {
        ...
        if (this.tabIndex == 0) {
          this.districtId = this.totalShow[t1].id;
          this.lineId = -1;
        } else {
          this.lineId = this.totalShow[t1].id;
          this.districtId = -1;
        }
      }
    },
